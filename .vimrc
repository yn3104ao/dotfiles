...
""search setting
"not incrimental search
set noincsearch

"highlight
set hlsearch

"ignore small & capital
set ignorecase
set smartcase
...
"show another file without save
set hidden
...
"swicth highlight double esc key
nnoremap <silent><Esc><Esc> :<C-u>set nohlsearch!<CR>
 
"prevent breake auto indent when pasted
if &term =~ "xterm"
    let &t_SI .= "\e[?2004h"
    let &t_EI .= "\e[?2004l"
