...
--- refs: https://github.com/yutkat/dotfiles/blob/main/.config/wezterm/wezterm.lua
local wezterm = require("wezterm")
local utils = require("utils")
local keybinds = require("keybinds")
local scheme = require("select_scheme")
require("on")
...
local config = {
	--- For Windows
	--- default_prog = {"C:\\Program Files\\PowerShell\\7"}
	default_prog = {'pwsh', '-NoExit', '-Command', 'clear'},
	-- font = wezterm.font("Cica"),
	-- font_size = 10.0,
	font = wezterm.font_with_fallback({
		{family="PlemolJP Console NF", weight=450, stretch="Normal", style="Normal"},
	}),
	font_size = 13,
	-- cell_width = 1.1,
	-- line_height = 1.1,
